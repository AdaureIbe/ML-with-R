...
ggplot(data=std_met_plot, aes(x=Decade, y=`Met Standard Deviation`)) +
  ...
  geom_hline(aes(yintercept=mean(`Met Standard Deviation`)),color="blue", linetype="dashed", size=1)+
...
ggplot(data=mean_met_plot, aes(x=Decade, y=`Met Temperature Mean`)) +
  ...
  scale_x_continuous(breaks = seq(1850,2020, by=10))+
  geom_hline(aes(yintercept=mean(`Met Temperature Mean`)),color="blue", linetype="dashed", size=1)+
...
ggplot(data=std_nasa_plot, aes(x=Decade, y=`Nasa Standard Deviation`)) +
  ...
  geom_hline(aes(yintercept=mean(`Nasa Standard Deviation`)),color="blue", linetype="dashed", size=1)+
...
ggplot(data=mean_nasa_plot, aes(x=Decade, y=`Nasa Temperature Mean`)) +
  ...
  scale_y_continuous(breaks = seq(13.5, 15, by=0.1))+
  scale_x_continuous(breaks = seq(1850,2020, by=10))+
  geom_hline(aes(yintercept=mean(`Nasa Temperature Mean`)),color="blue", linetype="dashed", size=1)+
